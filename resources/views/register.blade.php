  ...
  <main align="center" style="margin-top: 30px;margin: 60px 35%;background: white;padding: 20px 30px;border-radius: 10px" class="shadow">
    ...
    <form action="">
        <div class="row mt-3">
            <div class="col-sm-6" align="left">
                ...
                <input type="text" class="form-control" id="surname" placeholder="Họ" name="surname" @required(true)>
            </div>
            <div class="col-sm-6" align="left">
        ...
        <button type="submit" class="btn btn-dark" style="padding: 10px 20px;" >Đăng ký</button>
    </form>
    <div style="border-top: 1px solid black; margin-top: 20px">
        <button class="btn" style="padding: 10px 20px; background: #4CAF50; margin-top: 20px">
            <a href="#" style="color: white">Đăng nhập nếu đã có tài khoản</a>
        </button>
    </div>
  </main>
  <footer>
